// testRenderer.cpp : 애플리케이션에 대한 진입점을 정의합니다.
//
#include "stdafx.h"
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_TESTRENDERER, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_TESTRENDERER));
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   gameFramework.CreateGame(hInst, hWnd);
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_KEYDOWN:
    case WM_KEYUP:
        gameFramework.OnWindowMessage(hWnd, message, wParam, lParam);
        break;
    case WM_COMMAND:
        {
